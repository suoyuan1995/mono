...
if ($artifact)
{
	...
	{
		print(">>> lipo  $distDirSourceBin64/$file -create -output $distDirDestinationBin/$file\n\n");
		system ('lipo', "$distDirSourceBin64/$file", '-create', '-output', "$distDirDestinationBin/$file");
	}
